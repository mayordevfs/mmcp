...
import CategoryTypeFilter from '@/components/transfers/category-type-filter';
import TransactionList from '@/components/transfers/transaction-list';
export interface TransferMasterListFilterType {
  status: string;
  startDate: Date | null;
  endDate: Date | null;
  tranCode: string;
...
export default function TransferMasterListPage() {
    ...
    () =>
      axiosInstance.request({
        ...
        params: {
          ...
          pageNumber:page,
          pageSize:100,
          tranRefNo:termFilter?.tranRefNo||undefined,
          tranCode:termFilter?.tranCode||undefined
        },
      }),
    {
...
TransferMasterListPage.authenticate = {
  permissions: adminOnly,
};

TransferMasterListPage.Layout = Layout;
